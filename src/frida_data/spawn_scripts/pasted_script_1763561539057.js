### bypass-script.js
// MODIFICATION: Inline config and DEBUG_MODE for standalone use; default to true for verbose logging during Reddit/Gmail testing
...
// Unchanged: No additional standalone functions in base script -- Unchanged